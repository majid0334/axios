...
})({"6RZtd":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "76ee8e4e037a1287";
"use strict";
...
function getLocation() {
    if (navigator.geolocation) {
        ...
        function getWeather(position) {
            ...
            (0, _axiosDefault.default)(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=f4a027ad9e08d077764438d12ae27054&units=metric`).then(function(data) {
                return data;
                ...
                document.getElementById("main").innerText = "can not get weather describtion";
            });
        }
    } else console.log("Geolocation is not supported by this browser.");
}
const getBackgroundImage = ()=>{
    (0, _axiosDefault.default)("https://api.unsplash.com/photos/random/?client_id=crT3QVdozFZa56Y5AlLIZ4Y5p6rzXl5HZQLYGA1sJck").then(function(data) {
        return data;
    }).then(function(jsonData) {
        console.log(jsonData);
...
getBackgroundImage();
const getJoke = ()=>{
    (0, _axiosDefault.default)("https://official-joke-api.appspot.com/random_joke").then(function(data) {
        return data;
    }).then(function(jsonData) {
        console.log(jsonData);
...
getJoke();
const getActivity = ()=>{
    (0, _axiosDefault.default)("https://www.boredapi.com/api/activity").then(function(data) {
        return data;
    }).then(function(jsonData) {
        console.log(jsonData);
        document.getElementById("activity").innerText = `do this if bored: ${jsonData.data.activity}`;
    }).catch(function(error) {
        console.error(error);
        document.getElementById("activity").innerText = "can not ger random activity";
    });
};
getActivity();
...
var Buffer = require("26613c48a88f667e").Buffer;
"use strict";
/**
...
},{"26613c48a88f667e":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../env/classes/FormData.js":"lSnyf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("ecf616ee6239044e");
var ieee754 = require("74795081a97416e3");
...
},{"ecf616ee6239044e":"eIiSV","74795081a97416e3":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6RZtd","eqUwj"], "eqUwj", "parcelRequiref81b")

//# sourceMappingURL=index.037a1287.js.map
